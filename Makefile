...
check: all
	# sequential K-means ---------------------------------------------------
	./seq_main -o -q -b -n 2000 -i Image_data/color17695.bin
	./seq_main  -o -q   -n 100 -i Image_data/color100.txt

test: all
	diff Image_data/texture17695.bin.membership Image_data/correct_results/texture17695.bin.membership
	diff Image_data/texture17695.bin.cluster_centres Image_data/correct_results/texture17695.bin.cluster_centres

run: all
	./seq_main -o -q -b -n 2000 -i Image_data/texture17695.bin
	./seq_main -o -q -b -n 2000 -i Image_data/texture17695.bin
	./seq_main -o -q -b -n 2000 -i Image_data/texture17695.bin
	./seq_main -o -q -b -n 2000 -i Image_data/texture17695.bin
	./seq_main -o -q -b -n 2000 -i Image_data/texture17695.bin
